# Generated by Django 4.1.7 on 2024-02-06 03:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='customerrecords', to='recon.customers')),
            ],
        ),
        migrations.CreateModel(
            name='TldIndex',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('WordList', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='WordList', to='recon.wordlistgroup')),
            ],
        ),
        migrations.CreateModel(
            name='whois',
            fields=[
                ...
                ('map_image', models.ImageField(blank=True, upload_to='./recon/static/images/maps/')),
                ('customer_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='whois_customers', to='recon.customers')),
            ],
        ),
        migrations.CreateModel(
            name='ThreatModeling',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_threat_modeling', to='recon.customers')),
            ],
        ),
        migrations.CreateModel(
            name='Template',
            fields=[
                ...
                ('Submitted', models.BooleanField(default='False')),
                ('record_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Templates_record', to='recon.record')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='RecRequestMetaData', to='recon.record')),
            ],
        ),
        migrations.CreateModel(
            name='PythonNuclei',
            fields=[
                ...
                ('vulnCard_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PythonNuclei_record', to='recon.vulncard')),
            ],
        ),
        migrations.CreateModel(
            name='projectManger',
            fields=[
                ...
                ('customer_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='customer_projectManger', to='recon.customers')),
            ],
        ),
        migrations.CreateModel(
            name='Nuclei',
            fields=[
                ...
                ('record_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nucleiRecords_record', to='recon.record')),
            ],
        ),
        migrations.CreateModel(
            name='Nmap',
            fields=[
                ...
                ('record_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Nmaps_record', to='recon.record')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CPEServiceID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='CPEService', to='recon.cpeid')),
                ('csv_version_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='CsvVersion', to='recon.csv_version')),
                ('nist_record_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Nist_records', to='recon.record')),
            ],
        ),
        migrations.CreateModel(
            name='GnawControl',
            fields=[
                ...
                ('scan_objects', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=256), blank=True, default=list, size=None)),
                ('SubdomainsSeen', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=256), blank=True, default=list, size=None)),
                ('egoAgent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='egoAgent', to='recon.egoagent')),
            ],
        ),
        migrations.CreateModel(
            name='GEOCODES',
            fields=[
                ...
                ('record_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='GEOCODES', to='recon.record')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matchedAt_bodys', models.CharField(blank=True, max_length=2048)),
                ('curl_command', models.TextField(blank=True)),
                ('FoundVuln_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='VulnDetails', to='recon.foundvuln')),
            ],
        ),
        migrations.AddField(
            model_name='foundvuln',
            name='record_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='foundVuln_record', to='recon.record'),
        ),
        migrations.AddField(
            model_name='foundvuln',
            name='vuln_cardId',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vuln_cardId', to='recon.vulncard'),
        ),
        migrations.CreateModel(
            name='FindingMatrix',
            fields=[
                ...
                ('projectManMatrix_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projectManMatrix_id', to='recon.projectmanger')),
            ],
        ),
        migrations.CreateModel(
            name='DocManger',
            fields=[
                ...
                ('comment', models.TextField(unique=True)),
                ('Files', models.FileField(blank=True, upload_to='Matrix/Files')),
                ('projectManDoc_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projectManDoc_id', to='recon.projectmanger')),
            ],
        ),
        migrations.CreateModel(
            name='DNSQuery',
            fields=[
                ...
                ('record_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='DNSQuery_record', to='recon.record')),
            ],
        ),
        migrations.CreateModel(
            name='DNSAuthority',
            fields=[
                ...
                ('record_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='DNSAuthority_record', to='recon.record')),
            ],
        ),
        migrations.CreateModel(
            name='Credential',
            fields=[
                ...
                ('credential', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='credentials_customers', to='recon.customers')),
            ],
        ),
        migrations.CreateModel(
            name='Certificate',
            fields=[
                ...
                ('record_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Certificates_record', to='recon.record')),
            ],
        ),
        migrations.CreateModel(
            name='api',
            fields=[
                ...
                ('apiproviders_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='ApiProviders', to='recon.apiproviders')),
            ],
        ),
    ]
