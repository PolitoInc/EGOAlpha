...
class projectMangerSerializer(serializers.ModelSerializer):
    class Meta:
        model = projectManger
        fields = (
            'id',
...
class DocMangerSerializer(serializers.ModelSerializer):
    class Meta:
        model = DocManger
        fields = (
            'id',
...
#############################################################
#############################################################
class projectDocMangerSerializer(serializers.ModelSerializer):
    projectManDoc_id = DocMangerSerializer(many=True)
    projectManMatrix_id = FindingMatrixSerializer(many=True)
    class Meta:
        model = projectManger
        fields = (
            'id',
...
class CustomerRecordSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.reconOnly = validated_data.get('reconOnly', instance.reconOnly)
