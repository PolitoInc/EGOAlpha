                ...
                if portscan_bool == True:
                    ...
                    if scan_all_ports == False:
                        ...
                        for domain in Scan_target:
                            ...
                            print(domain, top_1000_port_scan_result)
                                    ...
                                    if 'ports' not in str(i):
                                        ...
                                        for i in ports_results:
                                            ...
                                            if TOTALCPE == 'null':
                                                ...
                                                nist_url = requests.get(url=url, verify=False, headers=headers, timeout=60)
                                                nist_rjson = nist_url.json()
                                                nist_cpe_check = [ cpe for cpe in nist_rjson if cpe['cpeId'] == CPE ]
                                                if len(nist_cpe_check) > 0:
                                                    print(len(nist_cpe_check))
                                                    print('nist_cpe_check')
                                                    pass
                                                else:
                                                    CPEID = f'{CPE}:{service}'
                                                    ...
                                                    try:
                                                                ...
                                                                if k == 'descriptions':
                                                                    ...
                                                                    for d in descript:
                                                                        ...
                                                                        for score in cvs:
                                                                            ...
                                                                            print('csv_id_found_Not',csv_id_found_Not)
                                                                            ...
                                                                            if len(csv_id_found_Not) > 0:
                                                                                ...
                                                                                csv_id_found_dict = dict.fromkeys(['csv_version_id'],csv_id_found_Not)
                                                                            if len(recs) == 0:
                                                                                dic={}
                                                                                ...
                                                                                print('/api/Nist/create',request.json())
                                                                            if len(csv_resp) == 0:
                                                                                print('0')
                                                                                dic = {}
                                                                                dic.update(s)
                                                                                ...
                                                                                print('csv_urlcreateresp',csv_urlcreateresp)
                                                                                ...
                                                                                if len(deresp_json) == 0:
                                                                                    ...
                                                                                    resp= request.json()
                                                                                    #nmapNistVulns_i = dict.fromkeys(['nmapNistVulns'], respid['id'])
                                                                                    print(resp)
                                                                                    descr_check = [resp for resp in deresp_json if resp['descriptions'] == str(descript)]

                                                                            else:
                                                                                if len(csv_id_found_Not) == 0 :
                                                                                    print(len(csv_id_found_Not),'1')
                                                                                    dic = {}
                                                                                    dic.update(s)
                                                        ...
                                                        timeout=60
                                                                                    ...
                                                                                    if len(deresp_json) == 0:
                                                                                        nistdesp_create_url = f'{HostAddress}:{Port}/api/NistDescription/create'
                                                                                        print('CPEServiceID_id',CPEServiceID_id)
                                                                                        dic = {}
                                                                                        dic.update(dict_CPE)
                                                                                        dic.update(refeDict)
                                                                                        dic.update(DESCRIPT)
                                                                                    ...
                                                                                    print('csv_id_found',csv_id_found_True)
                                            ...
                                            for i in ports_results:
                                                ...
                                                if TOTALCPE == 'null':
                                                    ...
                                                    if len(nist_cpe_check) > 0:
                                                        ...
                                                        url = f"https://services.nvd.nist.gov/rest/json/cves/2.0?cpeName=cpe:2.3:{TOTALCPE}"
                                                        header = {"Authorization": "bearer  ee7d9713-3103-4285-a191-e8e582864dd8"}
                                                        print(f'hereeeeenistnistnistnistnistnistnistnistnistnisteeeeeeeeeeeeeee {url} nist')
                                                        print(url)
                                                        try:
                                                            nist_rjson_response = requests.get(
                                                                url=url,
